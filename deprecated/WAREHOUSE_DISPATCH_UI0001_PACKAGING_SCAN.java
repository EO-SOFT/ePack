    ...
    public boolean updateStatus() {
        ...
        try {
            ...
            if (bc != null) {
                ...
                query.setParameter("containerState", GlobalVars.PALLET_DISPATCHED);
                query.setParameter("containerStateCode", GlobalVars.PALLET_DISPATCHED_CODE);
            ...
            //##########################################################
                ...
                hbc.setContainerState(GlobalVars.PALLET_DISPATCHED);
                hbc.setContainerStateCode(GlobalVars.PALLET_DISPATCHED_CODE);
                hbc.create(hbc);
                this.searchForPallet(store_txt.getText().substring(GlobalVars.CLOSING_PALLET_PREFIX.length()));
