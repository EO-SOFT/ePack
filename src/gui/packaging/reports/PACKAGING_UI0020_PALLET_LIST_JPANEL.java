...
public final class PACKAGING_UI0020_PALLET_LIST_JPANEL extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jpanel_state.setBackground(new java.awt.Color(255, 255, 255));
        jpanel_state.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void export_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_export_btnActionPerformed
        ...
        row.createCell(13).setCellValue("DISPATCH LABEL NO");
        ...
        for (Object[] obj : this.resultList) {
            ...
            row.createCell(13).setCellValue(Integer.valueOf(String.valueOf(obj[13])));//DISPATCH LABEL NO
...
//        refresh();
    ...
    javax.swing.JPanel jpanel_state;
